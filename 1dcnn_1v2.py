# -*- coding: utf-8 -*-
"""Copy of Clean_1DCNN_1v2

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1ObaG7_yiGjERCuVBBc7ry6kCUxp03zGk
"""
...
#1
modelC2.add(Conv1D(filters=64, kernel_size=3,strides = 1, padding='same', activation='relu', 
                        input_shape=(200, 12)))
...
# train the model
checkpointer = ModelCheckpoint(filepath='drive/My Drive/Models_Bhuti/CNNC2_wo.weights.best.hdf5', verbose=1, 
                               save_best_only=True)
...
modelC2.load_weights('drive/My Drive/Models_Bhuti/CNNC2_wo.weights.best.hdf5')
